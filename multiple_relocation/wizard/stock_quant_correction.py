...
class StockQuantAdjustmentLine(models.Model):
    ...
    old_quantity = fields.Float(string='Old Quantity', readonly=True, digits='Product Unit of Measure')
    ...
    old_x_studio_2nd_uom = fields.Float(string='Old Total Quantity', readonly=True, digits='Product Unit of Measure')
    ...
    new_quantity = fields.Float(string='New Quantity', digits='Product Unit of Measure')
    ...
    new_x_studio_2nd_uom = fields.Float(string='New Total Quantity', digits='Product Unit of Measure')
